class Repository extends HTMLElement {
    ...
    render() {
        this.innerHTML = `
            <p class="space">
            <h6 class="text-link">${this.name}</h6>
            <span class="h5">${this.description}</span>
       
            <div>
                <span class="h6"> ${this.language}</span>
                ...
                <span class="h6">${this.stars}</span>
            </div>
        `;
    }
}

customElements.define('g-repository', Repository)